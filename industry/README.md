...
- **[DroidSpeak](https://www.microsoft.com/en-us/research/publication/droidspeak-kv-cache-sharing-for-efficient-multi-llm-serving/)**
  `Microsoft Research` · `2026` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
...
- **[AlayaDB](https://arxiv.org/abs/2504.10326)**
  `AlayaDB AI + academia` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `kv-cache`
...
- **[Context Parallelism for Million-Token Inference](https://proceedings.mlsys.org/paper_files/paper/2025/hash/78834433edc3291f4c6cbbd2759324db-Abstract-Conference.html)**
  `Meta` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `prefill`
...
- **[JetStream + MaxText](https://cloud.google.com/tpu/docs/tutorials/LLM/jetstream-maxtext-inference-v6e)**
  `Google Cloud` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
...
- **[NCCL](https://github.com/NVIDIA/nccl)**
  `NVIDIA` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `gpu` `moe`
...
- **[KVServe](https://arxiv.org/abs/2605.13734)**
  `KVServe Team` · `2026` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
...
- **[SAW-INT4](https://arxiv.org/abs/2604.19157)**
  `Apple / academic collaboration` · `2026` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
...
- **[Instinct MI350 Series](https://www.amd.com/en/products/accelerators/instinct/mi350.html)**
  `AMD` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `amd` `moe`
...
- **[MLA / Multi-head Latent Attention](https://arxiv.org/abs/2412.19437)**
  `DeepSeek` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
...
- **Featured:** **[FlashInfer](https://proceedings.mlsys.org/paper_files/paper/2025/file/dbf02b21d77409a2db30e56866a8ab3a-Paper-Conference.pdf)**
  `FlashInfer 社区` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: foundation`
...
- **Featured:** **[FlexAttention for inference](https://pytorch.org/blog/flexattention-for-inference/)**
  `Meta / PyTorch` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: foundation`
  Tags: `kernel`
...
- **[FlexAttention](https://pytorch.org/blog/flexattention/)**
  `PyTorch` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: foundation`
  Tags: `kernel`
...
- **[LMCache Operator](https://github.com/LMCache/LMCache/releases/tag/operator-v0.1.1)**
  `LMCache 社区` · `2026` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
...
- **[MI325X architecture-aware deployment study](https://arxiv.org/abs/2603.10031)**
  `AMD ROCm ecosystem` · `2026` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `amd` `rocm` `moe`
...
- **[TileLang](https://github.com/tile-ai/tilelang)**
  `Microsoft Research / community` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `gpu` `kernel` `moe`
...
- **[WaferLLM on Cerebras WSE-2](https://www.usenix.org/conference/osdi25/technical-sessions)**
  `Microsoft Research + University of Edinburgh` · `2025` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: frontier`
  Tags: `kernel`
...
- **[TT-Metalium / Wormhole](https://github.com/tenstorrent/tt-metal)**
  `Tenstorrent` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `kernel`
...
- **[LightLLM](https://github.com/ModelTC/lightllm)**
  `ModelTC community` · `2023` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `serving` `kernel`
  用 token attention、动态 batch、共享显存管理和定制 Triton kernel 提供低开销分布式 LLM serving。
- **[MLC-LLM](https://github.com/mlc-ai/mlc-llm)**
  `MLC community` · `2023` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
...
- **[DeepSpeed-Inference](https://www.deepspeed.ai/tutorials/inference-tutorial/)**
  `Microsoft` · `2022` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `kernel` `memory`
...
- **[TurboTransformers](https://github.com/Tencent/TurboTransformers)**
  `Tencent` · `2021` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
...
- **[JetStream / MaxText / Pathways on TPU](https://github.com/AI-Hypercomputer/JetStream)**
  `Google` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `serving` `tpu`
...
- **[MindIE](https://www.hiascend.com/software/mindie)**
  `Huawei Ascend` · `2024` · `Industry / engineering material` · `Industrial Material · Legacy Import` · `Reading priority: supporting`
  Tags: `serving` `npu`
