...
- **Featured:** **FastServe: Iteration-Level Preemptive Scheduling for Large Language Model Inference**
...
- **A Queueing-Theoretic Framework for Stability Analysis of LLM Inference with KV Cache Memory Constraints**
  `ICML 2026` · `2026` · `Formal Conference · Legacy Import`
...
- **Cache What Lasts: Token Retention for Memory-Bounded KV Cache in LLMs**
  `ICLR 2026` · `2026` · `Formal Conference · Legacy Import`
  Tags: `kv-cache` `memory`
...
- **Context Parallelism for Scalable Million-Token Inference**
  `MLSys 2025` · `2025` · `Formal Conference · Legacy Import`
  Tags: `decode` `prefill`
...
- **Fast State Restoration in LLM Serving with HCache**
  `EuroSys 2025` · `2025` · `Formal Conference · Legacy Import`
...
- **IC-Cache: Efficient Large Language Model Serving via In-context Caching**
  `SOSP 2025` · `2025` · `Formal Conference · Legacy Import`
...
- **NanoFlow: Towards Optimal Large Language Model Serving Throughput**
  `OSDI 2025` · `2025` · `Formal Conference · Legacy Import`
...
- **Cost-Efficient Large Language Model Serving for Multi-turn Conversations with CachedAttention**
  `USENIX ATC 2024` · `2024` · `Formal Conference · Legacy Import`
...
- **InfiniGen: Efficient Generative Inference of Large Language Models with Dynamic KV Cache Management**
  `OSDI 2024` · `2024` · `Formal Conference · Legacy Import`
  Tags: `kv-cache` `memory`
...
- **FlexGen: High-Throughput Generative Inference of Large Language Models with a Single GPU**
  `ICML 2023` · `2023` · `Formal Conference · Legacy Import`
...
- **AdaCache: Adaptive Caching and Context Augmentation for Efficient LLM Serving**
  `ICLR 2026 Poster` · `2026` · `Poster / Workshop · Legacy Import`
  Tags: `prefill` `serving` `agent` `rag`
...
- **Efficient LLM Serving for Agentic Workflows with Context-Aware State Management**
  `EuroSys 2026 poster` · `2026` · `Poster / Workshop · Legacy Import`
  Tags: `prefill` `serving` `agent` `rag`
...
- **AdaptCache: KV Cache Native Storage Hierarchy for Low-Delay and High-Quality Language Model Serving**
  `SOSP 2025 BigMem Workshop` · `2025` · `Poster / Workshop · Legacy Import`
...
- **Agent-Assisted Side-Channel Attacks on Non-Prefix KV Cache in RAG**
  `arXiv 预印本, 2026` · `2026` · `Preprint · Legacy Import`
...
- **KV Cache Optimization Strategies for Scalable and Efficient LLM Inference**
  `arXiv 综述, 2026` · `2026` · `Preprint · Legacy Import`
  Tags: `kv-cache`
...
- **AccelGen: Heterogeneous SLO-Guaranteed High-Throughput LLM Inference Serving for Diverse Applications**
  `arXiv 预印本, 2025` · `2025` · `Preprint · Legacy Import`
...
- **Hydragen: High-Throughput LLM Inference with Shared Prefixes**
  `arXiv 预印本, 2024` · `2024` · `Preprint · Legacy Import`
  Tags: `rag` `throughput`
...
- **The CAP Principle for LLM Serving: A Survey of Long-Context Large Language Model Serving**
  `arXiv 综述, 2024` · `2024` · `Preprint · Legacy Import`
  Tags: `serving` `long-context`
...
- **Accelerating Model Loading in LLM Inference by Programmable Page Cache**
  `FAST 2026` · `2026` · `Unclassified · Legacy Import`
...
- **CoX-MoE: Coalesced Expert Execution for High-Throughput MoE Inference with AMX-Enabled CPU-GPU Co-Execution**
  `DAC 2026` · `2026` · `Unclassified · Legacy Import`
...
- **RetroInfer: A Vector Storage Engine for Scalable Long-Context LLM Inference**
  `PVLDB 19(5), 2026` · `2026` · `Unclassified · Legacy Import`
...
- **ByteScale: Communication-Efficient Scaling of LLM Training with a 2048K Context Length on 16384 GPUs**
  `SIGCOMM 2025` · `2025` · `Unclassified · Legacy Import`
  Tags: `prefill` `training` `gpu`
  ByteScale 为超长上下文训练优化并行、通信与负载均衡，其集群网络机制可迁移到大规模 prefill。
- **Cache-Craft: Managing Chunk-Caches for Efficient Retrieval-Augmented Generation**
  `PACMMOD / SIGMOD 2025` · `2025` · `Unclassified · Legacy Import`
...
- **FACIL: Flexible DRAM Address Mapping for SoC-PIM Cooperative On-device LLM Inference**
  `HPCA 2025` · `2025` · `Unclassified · Legacy Import`
...
- **MaverIQ: Fingerprint-Guided Extrapolation and Fragmentation-Aware Layering for Intent-Based LLM Serving**
  `SC 2025` · `2025` · `Unclassified · Legacy Import`
  Tags: `serving` `rag`
...
- **Splitwise: Efficient Generative LLM Inference Using Phase Splitting**
  `ISCA 2024` · `2024` · `Unclassified · Legacy Import`
...
- **HexGen-2: Disaggregated Generative Inference of LLMs in Heterogeneous Environment**
  `ICLR 2025` · `2025` · `Formal Conference · Legacy Import`
  Tags: `gpu`
...
- **3DLS: A 3D Logic-Stacked Architecture for Disaggregated LLM Serving**
  `IEEE Computer Architecture Letters 2026` · `2026` · `Unclassified · Legacy Import`
  Tags: `decode` `serving`
...
- **KVServe: Service-Aware KV Cache Compression for Communication-Efficient Disaggregated LLM Serving**
  `SIGCOMM 2026` · `2026` · `Unclassified · Legacy Import`
...
- **Mooncake: A KVCache-centric Disaggregated Architecture for LLM Serving**
  `FAST 2025` · `2025` · `Unclassified · Legacy Import`
  Tags: `serving`
...
- **ThinKV: Thought-Adaptive KV Cache Compression for Efficient Reasoning Models**
  `ICLR 2026 Oral` · `2026` · `Formal Conference · Legacy Import`
...
- **MagicDec: Breaking the Latency-Throughput Tradeoff for Long Context Generation with Speculative Decoding**
  `ICML 2025` · `2025` · `Formal Conference · Legacy Import`
...
- **Medusa: Simple LLM Inference Acceleration Framework with Multiple Decoding Heads**
  `ICML 2024` · `2024` · `Formal Conference · Legacy Import`
  Tags: `kv-cache`
  Medusa 在目标模型上添加多个 decoding heads，无需独立 draft model 即可并行预测和验证多个未来 token。
- **Accelerating Large-Scale Inference with Anisotropic Vector Quantization**
  `ICML 2020` · `2020` · `Formal Conference · Legacy Import`
  Tags: `kv-cache` `quantization`
...
- **LIA: A Single-GPU LLM Inference Acceleration with Layer Bypass and Adaptive Speculative Decoding**
  `ISCA 2025` · `2025` · `Unclassified · Legacy Import`
  Tags: `gpu` `kv-cache`
...
- **SmallKV: Small Model Assisted Compensation of KV Cache Compression for Efficient LLM Inference**
  `NeurIPS 2025` · `2025` · `Unclassified · Legacy Import`
  Tags: `compression` `kv-cache`
...
- **POD-Attention: Unlocking Full Prefill-Decode Overlap for Faster LLM Inference**
  `ASPLOS 2025` · `2025` · `Formal Conference · Legacy Import`
...
- **MegaBlocks: Efficient Sparse Training with Mixture-of-Experts**
  `MLSys 2023` · `2023` · `Formal Conference · Legacy Import`
...
- **Punica: Multi-Tenant LoRA Serving**
  `arXiv 预印本, 2023/持续使用` · `2023` · `Preprint · Legacy Import`
...
- **Featured:** **HydraServe: Minimizing Cold Start Latency for Serverless LLM Serving in Public Clouds**
  `NSDI 2026` · `2026` · `Formal Conference · Legacy Import`
...
- **ExeGPT: Constraint-Aware Resource Scheduling for LLM Inference**
  `ASPLOS 2024` · `2024` · `Formal Conference · Legacy Import`
...
- **Prism: Cost-Efficient Multi-LLM Serving via GPU Memory Ballooning**
  `OSDI 2026` · `2026` · `Preprint · Legacy Import`
  Tags: `serving` `gpu`
...
- **Taming the Titans: A Survey of Efficient LLM Inference Serving**
  `arXiv 综述, 2025` · `2025` · `Preprint · Legacy Import`
  Tags: `serving`
...
- **Towards Efficient Generative Large Language Model Serving: A Survey from Algorithms to Systems**
  `arXiv 综述, 2023` · `2023` · `Preprint · Legacy Import`
  Tags: `serving`
...
- **EAGLE-2: Faster Inference of Language Models with Dynamic Draft Trees**
  `EMNLP 2024` · `2024` · `Unclassified · Legacy Import`
  EAGLE-2 根据 draft confidence 动态构建候选树，避免静态树在不同上下文中的效率损失。
- **SGLang: Efficient Execution of Structured Language Model Programs**
  `NeurIPS 2024` · `2024` · `Unclassified · Legacy Import`
...
- **Towards Sustainable Large Language Model Serving**
  `HotCarbon 2024` · `2024` · `Unclassified · Legacy Import`
  Tags: `serving` `gpu` `agent` `rag`
...
- **ShadowKV: KV Cache in Shadows for High-Throughput Long-Context LLM Inference**
  `ICML 2025 Spotlight` · `2025` · `Formal Conference · Legacy Import`
